...
DATA_DIR = ''
TRAINING_DIR = ''
VALIDATION_DIR = METADATA_PATH = VALIDATION_LABELS_PATH = ''
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='All', 
                        help="Which dataset to use (Deepfakes|Face2Face|FaceShifter|FaceSwap|NeuralTextures|DFDC|All)")
    ...
    #print(opt)
    BASE_DIR = opt.data_path#'/projects/academic/courses/cse666/yadvende/datasets/iFrame_datasets/FF_NDF'
    MODELS_PATH = opt.model_path#"/projects/academic/courses/cse666/yadvende/Models/EffiSwinT_iframe_NDF/"
    ...
    if opt.dataset != "All" and opt.dataset != "DFDC":
        ...
        folders = ["Original", "Deepfakes", "Face2Face", "FaceShifter", "FaceSwap", "NeuralTextures"]#"DFDC"
    ...
    for t in range(starting_epoch, opt.num_epochs + 1):
        ...
        valloss_flag = previous_loss <= total_val_loss
        ...
        if (train_correct>best_acc):# and (val_correct>best_val_acc):
            best_acc = train_correct
            best_val_acc = val_correct
            print("Checkpoint Saved...")
            torch.save(model.state_dict(), os.path.join(MODELS_PATH,  "SwinT_Efficient"+str(opt.efficient_net)+"_checkpoint0" + "_" + opt.dataset))
